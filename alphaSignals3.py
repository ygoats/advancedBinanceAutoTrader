...
symbol_list3 = symbol_list3.symbol_list   ####ALL BINANCE FUTURES
...
def getTF5M():
    ...
    try:
        ...
        klines1 = client.futures_klines(symbol=symbol_list3[0],interval=KLINE_INTERVAL_5MINUTE, limit=50)
    except Exception as e:
        pd = open('pingData alphaSignals3', 'a')
        pd.write("\n" + str(t) + str(e))
        pd.close()
        print(str(e))
        sleep(60)
...
def getTF15M():
    ...
    try:
        client = Client(apiData.APIKey, apiData.SecretKey)
        klines2 = client.futures_klines(symbol=symbol_list3[0],interval=KLINE_INTERVAL_15MINUTE, limit=50)
    except Exception as e:
        pd = open('pingData alphaSignals3', 'a')
        pd.write("\n" + str(t) + str(e))
        pd.close()
...
def getTF1H():
    ...
    try:
        client = Client(apiData.APIKey, apiData.SecretKey)
        klines3 = client.futures_klines(symbol=symbol_list3[0],interval=KLINE_INTERVAL_1HOUR, limit=50)
    except Exception as e:
        pd = open('pingData alphaSignals3', 'a')
        pd.write("\n" + str(t) + str(e))
        pd.close()
...
def getTF4H():
    ...
    try:
        client = Client(apiData.APIKey, apiData.SecretKey)
        klines4 = client.futures_klines(symbol=symbol_list3[0],interval=KLINE_INTERVAL_4HOUR, limit=50)
    except Exception as e:
        pd = open('pingData alphaSignals3', 'a')
        pd.write("\n" + str(t) + str(e))
        pd.close()
...
def getTF1D():
    ...
    try:
        client = Client(apiData.APIKey, apiData.SecretKey)
        klines5 = client.futures_klines(symbol=symbol_list3[0],interval=KLINE_INTERVAL_1DAY, limit=21)
    except Exception as e:
        pd = open('pingData alphaSignals3', 'a')
        pd.write("\n" + str(t) + str(e))
        pd.close()
...
def Main():   
    ...
    now = datetime.now()
    t = now.strftime("%m/%d/%Y, %H:%M:%S")
    print('alphaSignals3 Running @ ' + str(t))
    
    qList1 = []
    conNode = False

    symbolLength = len(symbol_list3)
    ...
    while symbolLength > 0:
        ...
        #ATC5M[M10][F][ATR62]
        skipRun = False
        if symbol_list3[0] in symbol_listActiveBuy1 or \
            symbol_list3[0] in symbol_listActiveSell1:
                skipRun = True
        ...
        if skipRun == False:
            ...
            try:
                for b in range(21):
                    pRise = float(klines5[b][2])-float(klines5[b][3])
                    atrList.append(pRise)
                    atrSum = sum(atrList)
                    atrAvg = atrSum / 21
                    atrToday = float(klines5[20][2])-float(klines5[20][3])
            except IndexError as e:
                print(e)
                symbolLength = float(symbolLength) - 1
                symbol_list3.remove(symbol_list3[0])
                continue
            ...
            if buyConditionMet == True and atc == True and swingIsLower == True and currentPrice <= entryPointBuy and currentPrice > indexLowSignalLow and indexLow1 > indexHigh1 and activeTrades <= 9 and riskBuy <= 25 and targetBuy >= 5 and atrToday < atrAvg:
                ...
                symbol_listActiveBuy1.append(symbol_list3[0])
            ...
            if sellConditionMet == True and atcS == True and swingIsHigher == True and currentPrice >= entryPointSell and currentPrice < indexHighSignalHigh and indexHigh1 > indexLow1 and activeTrades <= 9 and riskSell <= 25 and targetSell >= 5 and atrToday < atrAvg:
                ...
                symbol_listActiveSell1.append(symbol_list3[0])
        ...
        #ATC15M[M10][F][ATR62]
        skipRun = False
        if symbol_list3[0] in symbol_listActiveBuy2 or \
            symbol_list3[0] in symbol_listActiveSell2:
                skipRun = True
        ...
        if skipRun == False:
            ...
            if buyConditionMet == True and atc == True and swingIsLower == True and currentPrice <= entryPointBuy and currentPrice > indexLowSignalLow and indexLow1 > indexHigh1 and activeTrades <= 9 and riskBuy <= 25 and targetBuy >= 5 and atrToday < atrAvg:
                ...
                symbol_listActiveBuy2.append(symbol_list3[0])
            ...
            if sellConditionMet == True and atcS == True and swingIsHigher == True and currentPrice >= entryPointSell and currentPrice < indexHighSignalHigh and indexHigh1 > indexLow1 and activeTrades <= 9 and riskSell <= 25 and targetSell >= 5 and atrToday < atrAvg:
                ...
                symbol_listActiveSell2.append(symbol_list3[0])
        ...
        #ATC1H[M10][F][ATR62]
        skipRun = False
        if symbol_list3[0] in symbol_listActiveBuy3 or \
            symbol_list3[0] in symbol_listActiveSell3:
                skipRun = True
        ...
        if skipRun == False:
            ...
            if buyConditionMet == True and atc == True and swingIsLower == True and currentPrice <= entryPointBuy and currentPrice > indexLowSignalLow and indexLow1 > indexHigh1 and activeTrades <= 9 and riskBuy <= 25 and targetBuy >= 5 and atrToday < atrAvg:
                ...
                symbol_listActiveBuy3.append(symbol_list3[0])
            ...
            if sellConditionMet == True and atcS == True and swingIsHigher == True and currentPrice >= entryPointSell and currentPrice < indexHighSignalHigh and indexHigh1 > indexLow1 and activeTrades <= 9 and riskSell <= 25 and targetSell >= 5 and atrToday < atrAvg:
                ...
                symbol_listActiveSell3.append(symbol_list3[0])
        ...
        #ATC4H[M10][F][ATR62]
        skipRun = False
        if symbol_list3[0] in symbol_listActiveBuy4 or \
            symbol_list3[0] in symbol_listActiveSell4:
                skipRun = True
        ...
        if skipRun == False:
            ...
            if buyConditionMet == True and atc == True and swingIsLower == True and currentPrice <= entryPointBuy and currentPrice > indexLowSignalLow and indexLow1 > indexHigh1 and activeTrades <= 9 and riskBuy <= 25 and targetBuy >= 5 and atrToday < atrAvg:
                ...
                symbol_listActiveBuy4.append(symbol_list3[0])
            ...
            if sellConditionMet == True and atcS == True and swingIsHigher == True and currentPrice >= entryPointSell and currentPrice < indexHighSignalHigh and indexHigh1 > indexLow1 and activeTrades <= 9 and riskSell <= 25 and targetSell >= 5 and atrToday < atrAvg:
                ...
                symbol_listActiveSell4.append(symbol_list3[0])
        ...
        #ATC5M[M10][F][ATR100]
        skipRun = False
        if symbol_list3[0] in symbol_listActiveBuy5 or \
            symbol_list3[0] in symbol_listActiveSell5:
                skipRun = True
        ...
        if skipRun == False:
            ...
            if buyConditionMet == True and atc == True and swingIsLower == True and currentPrice <= entryPointBuy and currentPrice > indexLowSignalLow and indexLow1 > indexHigh1 and activeTrades <= 9 and riskBuy <= 25 and targetBuy >= 5 and atrToday < atrAvg:
                ...
                symbol_listActiveBuy5.append(symbol_list3[0])
            ...
            if sellConditionMet == True and atcS == True and swingIsHigher == True and currentPrice >= entryPointSell and currentPrice < indexHighSignalHigh and indexHigh1 > indexLow1 and activeTrades <= 9 and riskSell <= 25 and targetSell >= 5 and atrToday < atrAvg:
                ...
                symbol_listActiveSell5.append(symbol_list3[0])
        ...
        #ATC15M[M10][F][ATR100]
        skipRun = False
        if symbol_list3[0] in symbol_listActiveBuy6 or \
            symbol_list3[0] in symbol_listActiveSell6:
                skipRun = True
        ...
        if skipRun == False:
            ...
            if buyConditionMet == True and atc == True and swingIsLower == True and currentPrice <= entryPointBuy and currentPrice > indexLowSignalLow and indexLow1 > indexHigh1 and activeTrades <= 9 and riskBuy <= 25 and targetBuy >= 5 and atrToday < atrAvg:
                ...
                symbol_listActiveBuy6.append(symbol_list3[0])
            ...
            if sellConditionMet == True and atcS == True and swingIsHigher == True and currentPrice >= entryPointSell and currentPrice < indexHighSignalHigh and indexHigh1 > indexLow1 and activeTrades <= 9 and riskSell <= 25 and targetSell >= 5 and atrToday < atrAvg:
                ...
                symbol_listActiveSell6.append(symbol_list3[0])
        ...
        #ATC1H[M10][F][ATR100]
        skipRun = False
        if symbol_list3[0] in symbol_listActiveBuy7 or \
            symbol_list3[0] in symbol_listActiveSell7:
                skipRun = True
        ...
        if skipRun == False:
            ...
            if buyConditionMet == True and atc == True and swingIsLower == True and currentPrice <= entryPointBuy and currentPrice > indexLowSignalLow and indexLow1 > indexHigh1 and activeTrades <= 9 and riskBuy <= 25 and targetBuy >= 5 and atrToday < atrAvg:
                ...
                symbol_listActiveBuy7.append(symbol_list3[0])
            ...
            if sellConditionMet == True and atcS == True and swingIsHigher == True and currentPrice >= entryPointSell and currentPrice < indexHighSignalHigh and indexHigh1 > indexLow1 and activeTrades <= 9 and riskSell <= 25 and targetSell >= 5 and atrToday < atrAvg:
                ...
                symbol_listActiveSell7.append(symbol_list3[0])
        ...
        #ATC4H[M10][F][ATR100]
        skipRun = False
        if symbol_list3[0] in symbol_listActiveBuy8 or \
            symbol_list3[0] in symbol_listActiveSell8:
                skipRun = True
        ...
        if skipRun == False:
            ...
            if buyConditionMet == True and atc == True and swingIsLower == True and currentPrice <= entryPointBuy and currentPrice > indexLowSignalLow and indexLow1 > indexHigh1 and activeTrades <= 9 and riskBuy <= 25 and targetBuy >= 5 and atrToday < atrAvg:
                ...
                symbol_listActiveBuy8.append(symbol_list3[0])
            ...
            if sellConditionMet == True and atcS == True and swingIsHigher == True and currentPrice >= entryPointSell and currentPrice < indexHighSignalHigh and indexHigh1 > indexLow1 and activeTrades <= 9 and riskSell <= 25 and targetSell >= 5 and atrToday < atrAvg:
                ...
                symbol_listActiveSell8.append(symbol_list3[0])
        ...
        try:
            ...
            if activeBuy1 > 0:
                for yx in range(activeBuy1):
                    ...
                    try:
                        ...
                        pd = open('pingData Swing5M[M10][F][ATR62]', 'a')
                        pd.write("\n" + str(t) + str(e))
                        pd.close()
                        print(str(e)) 
                        sleep(60)
                    ...
                    if float(currentPrice1) >= float(target_PriceLong1[yx]):
                        ...
                        f = open('dataSwing5M[M10][F][ATR62].txt', 'a')
                        f.write("\n" + str("{:.4f}".format(pnlLongWin)))
                        f.close()
                        
                        f = open('logSwing5M[M10][F][ATR62].txt', 'a')
            ...
            if activeBuy2 > 0:
                for yx in range(activeBuy2):
                    ...
                    try:
                        ...
                        pd = open('pingData Swing15M[M10][F][ATR62]', 'a')
                        pd.write("\n" + str(t) + str(e))
                        pd.close()
                        print(str(e)) 
                        sleep(60)
                    ...
                    if float(currentPrice1) >= float(target_PriceLong2[yx]):
                        ...
                        f = open('dataSwing15M[M10][F][ATR62].txt', 'a')
                        f.write("\n" + str("{:.4f}".format(pnlLongWin)))
                        f.close()
                        
                        f = open('logSwing15M[M10][F][ATR62].txt', 'a')
            ...
            if activeSell2 > 0:
                for yv in range(activeSell2): 
                    ...
                    if float(currentPrice1) <= float(target_PriceShort2[yv]): 
                        ...
                        f = open('logSwing15M[10][F][ATR62].txt', 'a')
            ...
            if activeBuy3 > 0:
                for yx in range(activeBuy3):
                    ...
                    try:
                        ...
                        pd = open('pingData Swing1H[M10][F][ATR62]', 'a')
                        pd.write("\n" + str(t) + str(e))
                        pd.close()
                        print(str(e)) 
                        sleep(60)
                    ...
                    if float(currentPrice1) >= float(target_PriceLong3[yx]):
                        ...
                        f = open('dataSwing1H[M10][F][ATR62].txt', 'a')
                        f.write("\n" + str("{:.4f}".format(pnlLongWin)))
                        f.close()
                        
                        f = open('logSwing1H[M10][F][ATR62].txt', 'a')
            ...
            if activeBuy4 > 0:
                for yx in range(activeBuy4):
                    ...
                    try:
                        ...
                        pd = open('pingData Swing4H[M10][F][ATR62]', 'a')
                        pd.write("\n" + str(t) + str(e))
                        pd.close()
                        print(str(e)) 
                        sleep(60)
                    ...
                    if float(currentPrice1) >= float(target_PriceLong4[yx]):
                        ...
                        f = open('dataSwing4H[M10][F][ATR62].txt', 'a')
                        f.write("\n" + str("{:.4f}".format(pnlLongWin)))
                        f.close()
                        
                        f = open('logSwing4H[M10][F][ATR62].txt', 'a')
            ...
            if activeBuy5 > 0:
                for yx in range(activeBuy5):
                    ...
                    try:
                        ...
                        pd = open('pingData Swing5M[M10][F][ATR100]', 'a')
                        pd.write("\n" + str(t) + str(e))
                        pd.close()
                        print(str(e)) 
                        sleep(60)
                    ...
                    if float(currentPrice1) >= float(target_PriceLong5[yx]):
                        ...
                        f = open('dataSwing5M[M10][F][ATR100].txt', 'a')
                        f.write("\n" + str("{:.4f}".format(pnlLongWin)))
                        f.close()
                        
                        f = open('logSwing5M[M10][F][ATR100].txt', 'a')
            ...
            if activeBuy6 > 0:
                for yx in range(activeBuy6):
                    ...
                    try:
                        ...
                        pd = open('pingData Swing15M[M10][F][ATR100]', 'a')
                        pd.write("\n" + str(t) + str(e))
                        pd.close()
                        print(str(e)) 
                        sleep(60)
                    ...
                    if float(currentPrice1) >= float(target_PriceLong6[yx]):
                        ...
                        f = open('dataSwing15M[M10][F][ATR100].txt', 'a')
                        f.write("\n" + str("{:.4f}".format(pnlLongWin)))
                        f.close()
                        
                        f = open('logSwing15M[M10][F][ATR100].txt', 'a')
            ...
            if activeBuy7 > 0:
                for yx in range(activeBuy7):
                    ...
                    try:
                        ...
                        pd = open('pingData Swing1H[M10][F][ATR100]', 'a')
                        pd.write("\n" + str(t) + str(e))
                        pd.close()
                        print(str(e)) 
                        sleep(60)
                    ...
                    if float(currentPrice1) >= float(target_PriceLong7[yx]):
                        ...
                        f = open('dataSwing1H[M10][F][ATR100].txt', 'a')
                        f.write("\n" + str("{:.4f}".format(pnlLongWin)))
                        f.close()
                        
                        f = open('logSwing1H[M10][F][ATR100].txt', 'a')
            ...
            if activeBuy8 > 0:
                for yx in range(activeBuy8):
                    ...
                    try:
                        ...
                        pd = open('pingData Swing4H[M10][F][ATR100]', 'a')
                        pd.write("\n" + str(t) + str(e))
                        pd.close()
                        print(str(e)) 
                        sleep(60)
                    ...
                    if float(currentPrice1) >= float(target_PriceLong8[yx]):
                        ...
                        f = open('dataSwing4H[M10][F][ATR100].txt', 'a')
                        f.write("\n" + str("{:.4f}".format(pnlLongWin)))
                        f.close()
                        
                        f = open('logSwing4H[M10][F][ATR100].txt', 'a')
            ...
            print(str(e))
            #print(symbol_list3[0] + ' Parsed!') 
        
            qList1.append(symbol_list3[0])
            symbol_list3.remove(symbol_list3[0])
